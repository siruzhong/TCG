...
data_file_path = base_dir + f'/datasets/raw_data/{dataset_name}/{dataset_name}.xlsx'
# data_file_path = f'/home/public/raw_data/{dataset_name}/{dataset_name}.xlsx'# f'datasets/raw_data/{dataset_name}/{dataset_name}.xlsx'
...
def main():
    ...
    # Save processed data
    split_and_save_data(df, timestamps)

    # Save dataset description
    save_description(df, timestamps)
